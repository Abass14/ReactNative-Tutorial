...
const App = () => {
  ...
  return (
    <ImageBackground style={styles.body} source={require('../assets/background.png')}>
      ...
      <CustomButton onPressFunction={onPressHandler} title={isSubmitted? 'Submitted': 'Submit'} color='green' />
      <CustomButton onPressFunction={onPressHandler} title={isSubmitted? 'Submitted': 'Submit'} color='blue' style={{margin: 10}} />
